        ...
        <div className="w-full max-w-md rounded-2xl border border-indigo-100 bg-white p-8 shadow-xl shadow-indigo-500/5">
          <div className="text-center">
            ...
            <p className="mt-2 text-xs sm:text-sm text-neutral-500">
              Sign in with your Google account to access your Labora workspace and generate laboratory records.
            </p>
          </div>

          {errorMessage && (
            <div className="mt-4 flex items-start gap-2.5 rounded-xl border border-rose-200 bg-rose-50/80 p-3 text-xs text-rose-700">
