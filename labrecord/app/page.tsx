...
>
  {/* Stacked Sheet Underlayer (Creates realistic document stack depth) */}
  <div className="absolute inset-0 translate-y-3 scale-[0.96] rounded-2xl bg-[#eae5f8] opacity-70 blur-[1px]" />
  <div className="absolute inset-0 translate-y-1.5 scale-[0.98] rounded-2xl bg-[#f5f2fd] opacity-90 shadow-sm" />

  {/* Main Paper Window */}
  <div className="relative overflow-hidden rounded-2xl border border-[#d8d2e8] bg-white shadow-[0_24px_60px_-12px_rgba(45,35,80,0.14)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_32px_70px_-12px_rgba(45,35,80,0.2)]">
    ...
    <div className="flex items-center justify-between border-b border-[#eeeaf5] bg-[#faf8fc] px-4 py-2.5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="ml-2 font-mono text-[11px] font-medium text-[#736c84]">
          19AI410-Lab-Record.pdf
        </span>
      </div>

      <div className="flex items-center gap-1.5">
        <span className="inline-flex items-center gap-1 rounded-md bg-[#eeeaff] px-2 py-0.5 text-[10px] font-semibold text-[#5845c4]">
    ...
    {/* Printable Sheet Body (Strict A4 Aspect Feel) */}
    <div className="relative bg-white p-5 sm:p-7 font-serif text-black">
      ...
      <div className="relative mb-3 flex flex-col items-center border-b border-black/80 pb-2.5 text-center">
        <img
          src="/college-banner.png"
          alt="College banner"
          className="mb-1.5 block h-9 sm:h-11 w-auto max-w-full object-contain"
          onError={(e) => {
            // Graceful fallback if banner asset isn't loaded
            (e.currentTarget as HTMLElement).style.display = 'none';
          }}
        />

        <div className="font-bold tracking-tight text-[11px] sm:text-[12.5px] uppercase leading-snug">
          19AI410 / Machine Learning Laboratory
        </div>
        <div className="text-[9px] sm:text-[10px] font-bold text-neutral-800 uppercase tracking-widest mt-0.5">
          Record of Laboratory Work
        </div>
      </div>

      {/* Compact Official Table */}
      <table className="relative w-full border-collapse border border-black text-center text-[9px] sm:text-[10px]">
        <thead>
          <tr className="bg-neutral-100/80 font-bold">
            <th className="border border-black p-1 w-[8%] font-sans">Exp</th>
            <th className="border border-black p-1 w-[15%] font-sans">Date</th>
            <th className="border border-black p-1 text-left w-[47%] pl-2.5 font-sans">
              Name of The Experiment
            </th>
            <th className="border border-black p-1 w-[14%] font-sans">QR Code</th>
            <th className="border border-black p-1 w-[8%] font-sans">Mark</th>
            <th className="border border-black p-1 w-[8%] font-sans">Sign</th>
          </tr>
        </thead>
        <tbody>
          {/* Row 1 */}
          <tr className="hover:bg-neutral-50/70 transition-colors">
            <td className="border border-black p-1.5 font-mono text-[9px]">01</td>
            <td className="border border-black p-1.5 text-[8.5px] whitespace-nowrap text-neutral-800 font-sans">
              12/08/2026
            </td>
            <td className="border border-black p-1.5 text-left pl-2.5">
              <div className="font-semibold text-black leading-tight">
                Linear &amp; Polynomial Regression
              </div>
              <div className="truncate font-sans text-[7.5px] text-[#0563c1] hover:underline">
                https://github.com/student/ml-lab/exp-1
              </div>
            </td>
            <td className="border border-black p-1">
              <div className="mx-auto flex h-7 w-7 items-center justify-center rounded bg-neutral-50 p-0.5 shadow-2xs">
                <QrCodePreviewSvg />
              </div>
            </td>
            <td className="border border-black p-1.5 font-mono text-neutral-400">10</td>
            <td className="border border-black p-1.5">
              <span className="font-serif italic text-blue-900 text-[10px] opacity-80 select-none">
                Staff
              </span>
            </td>
          </tr>
          ...
          {/* Row 2 */}
          <tr className="hover:bg-neutral-50/70 transition-colors">
            <td className="border border-black p-1.5 font-mono text-[9px]">02</td>
            <td className="border border-black p-1.5 text-[8.5px] whitespace-nowrap text-neutral-800 font-sans">
              19/08/2026
            </td>
            <td className="border border-black p-1.5 text-left pl-2.5">
          ...
          {/* Row 3 */}
          <tr className="hover:bg-neutral-50/70 transition-colors">
            <td className="border border-black p-1.5 font-mono text-[9px]">03</td>
            <td className="border border-black p-1.5 text-[8.5px] whitespace-nowrap text-neutral-800 font-sans">
              26/08/2026
            </td>
            <td className="border border-black p-1.5 text-left pl-2.5">
      ...
      <div className="relative mt-3 pt-2 text-[8px] sm:text-[9px] text-neutral-800 font-sans">
        ...
        <div className="grid grid-cols-2 gap-2 border-t border-black/80 pt-2 font-serif text-[8.5px] sm:text-[9.5px]">
          <div>
